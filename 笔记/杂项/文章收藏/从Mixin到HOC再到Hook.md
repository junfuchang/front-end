...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a93f73ff19e~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a93f7719481~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
`React`官方文档在[Mixins Considered Harmful](https://link.juejin.cn/?target=https%3A%2F%2Freact.docschina.org%2Fblog%2F2016%2F07%2F13%2Fmixins-considered-harmful.html)一文中提到了`Mixin`带来了危害：
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a93f7d6879a~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a93f959e716~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a93f9a729dc~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
高阶组件中可获取原组件的`ref`，通过`ref`获取组件实力，如下面的代码，当程序初始化完成后调用原组件的log方法。(不知道refs怎么用，请👇[Refs & DOM](https://link.juejin.cn/?target=https%3A%2F%2Freact.docschina.org%2Fdocs%2Frefs-and-the-dom.html))
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a93fa0c3651~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a947a775967~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)



可以发现，所有的`writable`属性均被配置为了`false`，即所有属性是不可变的。（对这些配置项有疑问，请👇[defineProperty](https://link.juejin.cn/?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FJavaScript%2FReference%2FGlobal_Objects%2FObject%2FdefineProperty)）
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a949cfeb119~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
实际上这属于一类最常见的应用，多个组件拥有类似的逻辑，我们要对重复的逻辑进行复用， 官方文档中`CommentList`的示例也是解决了代码复用问题，写的很详细，有兴趣可以👇[使用高阶组件（HOC）解决横切关注点](https://link.juejin.cn/?target=https%3A%2F%2Freact.docschina.org%2Fdocs%2Fhigher-order-components.html%23%E4%BD%BF%E7%94%A8%E9%AB%98%E9%98%B6%E7%BB%84%E4%BB%B6%EF%BC%88hoc%EF%BC%89%E8%A7%A3%E5%86%B3%E6%A8%AA%E5%88%87%E5%85%B3%E6%B3%A8%E7%82%B9)。
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a94a5328c3b~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a94af19db54~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
如果原组件有非常多的静态属性，这个过程是非常痛苦的，而且你需要去了解需要增强的所有组件的静态属性是什么，我们可以使用[`hoist-non-react-statics`](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fmridgway%2Fhoist-non-react-statics)来帮助我们解决这个问题，它可以自动帮我们拷贝所有非`React`的静态方法，使用方式如下：
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a94c5d5a8dc~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a94cdafad9e~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a94cd939f75~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a94d2268081~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![image](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/4/10/16a04a94e8279309~tplv-t2oaga2asx-zoom-in-crop-mark:1304:0:0:0.awebp)
...
[【React深入】从Mixin到HOC再到Hook - 掘金 (juejin.cn)](https://juejin.cn/post/6844903815762673671)