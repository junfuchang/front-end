...
- 安装：傻瓜式安装，一路`next`
- 确认Node环境是否安装成功
  - 查看node的版本号：`node --version`或`node -v`
- 配置环境变量
...
[![image-20200314101047100]()](https://github.com/smallC-L-Y/Demo/blob/notes/nodeJS学习笔记.md)
...
[![image-20200314100821112]()](https://github.com/smallC-L-Y/Demo/blob/notes/nodeJS学习笔记.md)
